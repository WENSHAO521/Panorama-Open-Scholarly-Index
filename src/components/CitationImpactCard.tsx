...
export function CitationImpactCard({ stats, subjectPercentile }: { stats: OpenAlexSourceStats; subjectPercentile?: number | null }) {
  const rows = [
  ...
  return (
    <div className="bg-white p-4" style={{ border: '1px solid var(--posi-border)' }}>
      ...
      <p className="text-[10px] mt-3 leading-relaxed" style={{ color: 'var(--posi-muted)' }}>
        PCI = POSI Citation Impact (OpenAlex 2yr mean citedness). Not a Web of Science or Scopus metric.{' '}

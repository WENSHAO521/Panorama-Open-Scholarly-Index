  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      ...
      <section className="bg-white p-5" style={{ border: '1px solid var(--posi-border)' }}>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {[
            ...
            { title: 'PCS: one source, Crossref — real, frozen-spec-compliant data now published', body: 'PCS 1.0 (PCS-1.0-SPEC.md) is the mean is-referenced-by-count across a journal\'s articles published in the trailing 4 calendar years, computed directly from Crossref via full cursor pagination — no article-sample cap. A real run now exists, covering the Core Collection and curated Global Benchmark — see the PCS table below. The figure still shown on Citation Reports is a separate, earlier, capped-at-200-articles sample, labeled "Legacy Crossref Preview" there (not "PCS") specifically to avoid conflating the two. Like PCI, PCS is independent of OpenAlex and never averaged with it, and it does not determine Citation Rank, Percentile, or Quartile.' },
      ...
      <div className="flex flex-wrap gap-5 text-xs">
        <Link href="/pcs" style={{ color: 'var(--posi-accent)' }} className="hover:underline">POSI Citation Score — real data →</Link>
